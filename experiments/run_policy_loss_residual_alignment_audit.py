...
def main() -> None:
    ...
    parser.add_argument("--q-stage-epochs", type=int, default=40)
    parser.add_argument("--pvbp-stage-epochs", type=int, default=60)
    parser.add_argument("--q-refresh-stage-epochs", type=int, default=10)
